...
const scrapeLogic = async (res) => {
  ...
  try {
    console.log("Browser launching with Puppeteer...");
    ...
    await Promise.all([page.click(".blue-btn"), page.waitForNavigation({ timeout: 60000 })]);
    ...
    await Promise.all([page.click('[href="/mnjuser/profile"]'), page.waitForNavigation({ timeout: 60000 })]);
    ...
    await Promise.all([page.click(".widgetHead > .edit"), page.waitForNavigation({ timeout: 60000 })]);
